	...
	if !self.shacks then
		...
		elseif game.GetMap() == "bg_district34" then
			self.shacks = {
				...
				["M0"] = {pos1 = Vector(3240, -11016, 972), pos2 = Vector(3660, -10504, 1270), doorPos = Vector(3244, -10783, 1026), cost = 1200, bedTier = 2, stashSize = 120},
				...
				["R8"] = {pos1 = Vector(4395, -9720, 1212), pos2 = Vector(3394, -9720, 1384), doorPos = Vector(3712, -9213, 1266), cost = 1200, bedTier = 2, stashSize = 120},
