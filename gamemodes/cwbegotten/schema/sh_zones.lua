...
local HALL = zones:New("hall")
		HALL.name = "Hall Of Tears";
		HALL.map = "bg_district34";
		HALL.fogColors = {r = 0, g = 0, b = 0};
		HALL.fogStart = 0;
		HALL.fogEnd = 1200;
		HALL.colorModify = {["$pp_colour_brightness"] = -0.03, ["$pp_colour_contrast"] = 1.15, ["$pp_colour_colour"] = 0.85};
		HALL.bounds = {
			{
			min = Vector(-6952, -1789, 1040),
			max = Vector(-8689, 2878, 13274),
			},
			{
			min = Vector(3074, -1926, 10539),
			max = Vector(1938, 795, 11001),
			},
		};
	HALL:Register()
	...
	local MANOR = zones:New("manor", "suprahell")
		...
		MANOR.bounds = {
			...
			max = Vector(2364, -9681, -2300),
			},
			{
			min = Vector(1226, -7859, -4841),
			max = Vector(2364, -9675, -4664),
			},
			{
